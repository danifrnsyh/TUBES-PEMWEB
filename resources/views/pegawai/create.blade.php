...
<div class="row justify-content-center">
  <div class="col-lg-6">
    <div class="d-flex justify-content-between align-items-center mb-5">
      <div>
        <h1 class="display-6 fw-bold mb-1">Tambah Tim</h1>
        <p class="text-muted mb-0">Daftarkan anggota baru untuk tim operasional Three D.</p>
      </div>
    ...
    <div class="admin-form-card">
      <form action="{{ route('pegawai.store') }}" method="POST">
        ...
        <div class="mb-4">
          ...
          <input type="text" name="nama" class="form-control" placeholder="Misal: Ahmad Fauzi" required>
        ...
        <div class="mb-5">
          ...
          <input type="text" name="jabatan" class="form-control" placeholder="Misal: Manajer Gudang" required>
        ...
        <div class="d-grid pt-3">
          <button type="submit" class="btn btn-primary btn-lg rounded-pill shadow">
            <i class="bi bi-check-circle me-2"></i> Simpan Data Tim
          </button>
        </div>
      </form>
    </div>
